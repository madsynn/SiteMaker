...
{{-- <h4 class="section-name row">New Arrivals</h4> --}}
            ...
            <div id="shop" class="shop grid-container clearfix" data-layout="fitRows">
                ...
                @foreach($new_products as $product)
                    {{-- @foreach($new_products->features as $feature) --}}

                        {{--{!! var_dump($price->toArray()) !!}--}}

                        <div class="product clearfix pf-new" data-product-id="product-{{$product->id}}">
    ...
    {{--         <div class="product clearfix .pf-qn"></div><!-- #filter qnique end -->
            <div class="product clearfix .pf-mq"></div><!-- #filter machine quilting end -->
            <div class="product clearfix .pf-hq"></div><!-- #filter  hand quilting end -->
            <div class="product clearfix .pf-acc"></div><!-- #filter accessories end --> --}}
